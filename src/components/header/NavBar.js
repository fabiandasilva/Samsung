            ...
            <Container>
               ...
               <Navbar.Collapse id="responsive-navbar-nav">
                  <Nav className="me-auto">
                     <Nav.Link>
                        <Link to="/categoria/Galaxy Z">Galaxy Z</Link>
                     </Nav.Link>
                     <Nav.Link>
                        <Link to="/categoria/Galaxy S">Galaxy S</Link>
                     </Nav.Link>
                     <Nav.Link>
                        <Link to="/categoria/Galaxy Note">Galaxy Note</Link>
                     </Nav.Link>
                     <Nav.Link>
                        <Link to="/categoria/Galaxy A">Galaxy A</Link>
                     </Nav.Link>
                  </Nav>
                  <Nav>
                     <Nav.Link>
